<template>
  ...
  >
   ...
   :tareaToEdit="tareaToEdit"
    ref="refTareaCreateEditComponent"
    @updateT="updateTareaHandler()"
    @cancelT="cancelHandler()"></daic-tarea-edit>

    <template #modal-footer>
    <!--
      <b-button variant="outline-danger" @click="cancelHandler()"  >{{ $t('entity.action.cancel') }}</b-button>
      <b-button variant="primary" :disabled="!isFormValidCreate()"  @click="updateTareaHandler()" >{{ $t('entity.action.confirm') }}</b-button>
    -->
    </template>
  </b-modal>
  ...
  <b-modal
    ...
    header-text-variant="white"
  >
  <daic-tarea-edit :tareaToEdit="tareaToEdit"
  ref="refTareaEditComponent"
   @updateT="updateTareaHandler()"
  ...
  <b-modal
    ...
    header-text-variant="white"
  >
  <daic-tarea-edit :tareaToEdit="tareaToEdit" @updateT="deleteTareaHandler()" @cancelT="cancelHandler()" :readonly="true"></daic-tarea-edit>
